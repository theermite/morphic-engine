...
| F-026 | Axe lecture — Reading Focus toggle + intensité (low/medium/high ≈ 30/40/50%) — bold sur premières lettres de chaque mot pour guider la saccade | En tant qu'user à qui cette technique parle, j'active le focus lecture avec intensité réglable | P1 | F-002 |
...
- **F-026 Reading Focus** : technique de mise en gras des premières lettres pour guider les saccades. **Nom public "Reading Focus"** — la technique homonyme commerciale est une marque déposée (US #5557651, BRCG Casutt GmbH), incompatible avec un repo public AGPL. La méthode typographique elle-même n'est pas brevetable. **Demande utilisateurs forte mais evidence-based contesté** (méta-analyses 2022-2025 : pas d'effet sur la vitesse de lecture ; Joshua Snell 2024, Možina et al. 2025 ; un seul signal sur la rétention à 6 mois, faible réplication). Toggle OFF par défaut, opt-in user. Cadrage honnête dans la doc utilisateur ("certains lecteurs y trouvent un confort, l'evidence scientifique est mixte").
...
| 2026-05-22 | §3 + §7 — **F-026 renommé "Bionic Reading" → "Reading Focus"**. Le nom commercial est une marque déposée (US #5557651, BRCG Casutt GmbH, takedown effectif contre TorpedoRead en 2022). La technique typographique elle-même n'est pas brevetable. Renommage public AGPL préventif. Pas de changement de scope fonctionnel. | Jay : « On renomme partout. Sachant que pour une fois on travaille sur un dépôt public, je préfère que l'on fasse tout correctement. » | Jay (décision) + Takumi (veille trademark) |

...
| B-027 | Pillar article The Ermite « Adaptation morphique vs accessibility overlays — ce que la FTC a confirmé en 2025 » (~2050 mots, FR, sources vérifiées) + JSON-LD SoftwareApplication compagnon. Correction date : complaint FTC déposée 2025-01-03, final order 2025-04-22 (le Plan NLNet disait "2024" — investigation seulement). Article markdown source dans `docs/Articles/`, à publier via admin The-Ermite. | §12 SEO + GEO | 🟢 Done | — | schema.org SoftwareApplication, FTC press release 2025-01-03 (verifie 2026-05-25 via lflegal.com + adrianroselli.com WebFetch direct) | — | 2026-05-25 |

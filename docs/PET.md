...
| B-028 | Audit final GO/NO-GO Quality-Gates Refonte (4D ≥ 80/100) + Lighthouse ≥95 + axe 0 + Pa11y 0 + cross-browser pass. Phase 1 livrée : `docs/audits/Audit-GO-NO-GO-2026-05-28.md` — verdict NO-GO actuel (D2 65/100 + D4 75/100 < floor 80, total pondéré 82.5/100). Cause racine unique : 4 erreurs lint Biome (3 auto-fixables + 1 noNonNullAssertion `e2e-crypto.ts:234`). Tests 1291/1291 ✅, coverage 94.49 % stmts ✅, security 95/100 ✅. Remédiation + Lighthouse/axe à enchaîner. | §11 Compliance | 🟡 In progress | — | CDC §11 Quality-Gates Refonte + Quality.md "Zero lint errors" BLOCKING | — | 2026-05-28 |
